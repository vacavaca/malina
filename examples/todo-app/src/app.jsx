...
//   const from = Math.floor(Math.random() * (data.length - 1))
//   const to = Math.floor(Math.random() * (data.length - 1))

//   const buff = data.splice(from, 1, data.splice(to, 1)[0])[0]
//   data.splice(to, 0, buff);
...
// export default view(({ data }, actions) =>
//   <div>
//     <button onClick={actions.add}>Add 1000 rows</button>
//     <button onClick={actions.swap}>Swap</button>
